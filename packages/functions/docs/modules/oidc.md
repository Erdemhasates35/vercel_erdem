...
[packages/functions/src/oidc/aws-credentials-provider.ts:70](https://github.com/Erdemhasates35/vercel_erdem/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L70)
